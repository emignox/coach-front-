...
function Gym() {
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen gap-5 font-black text-gray-100 md:flex-row-reverse md:flex md:gap-44 md:justify-center md:items-center">
